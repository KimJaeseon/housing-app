...
export default function App(){
 ...
 {!(demo?busy:api.busy)&&<Button label={demo?'다시 조사하기 · 예시':'다시 조사하기'} onPress={search}/>}</>:!demo&&selectedNotice?<NoticeDetail key={selectedNotice.id} notice={selectedNotice} loadSupply={api.loadSupply} loadDocument={api.loadDocument}/>:<>
